...
/**
 * A class which compares the wizards at Slytherin from greatest to least according to offensive points
 * Nombre del grupo: Depé SL
 * @author Daniel Corzo González, Ángel Romero Trigo & Manuel Rodriguez Rodriguez
 * @version 1.0
 */
public class ComparatorSlytherin extends MegaComparator
{
